# How to contribute to  cozy-lasuite-visio?
...
- What is the version of the  cozy-lasuite-visio app?
...
```
$ git clone github.com/cozy/ cozy-lasuite-visio.git
$ cd  cozy-lasuite-visio
$ git remote add fork git://github.com/yourusername/ cozy-lasuite-visio.git
```
...
Go to https://github.com/yourusername/ cozy-lasuite-visio and select your branch. Click the 'Pull Request' button and fill out the form.
...
The  cozy-lasuite-visio is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/ cozy-lasuite-visio/issues/new
...
[localization]: https://github.com/cozy/ cozy-lasuite-visio/blob/master/README.md#localization
